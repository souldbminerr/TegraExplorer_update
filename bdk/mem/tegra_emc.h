...
#define EMC_FBIO_CFG7_CH0_ENABLE_ENABLE  ((uint32_t)1)
#define EMC_FBIO_CFG7_CH1_ENABLE_ENABLE  ((uint32_t)1)
#define EMC_FBIO_CFG7_CH0_ENABLE_DISABLE ((uint32_t)0)
#define EMC_FBIO_CFG7_CH1_ENABLE_DISABLE ((uint32_t)0)
#define EMC_DBG_WRITE_MUX_ASSEMBLY       ((uint32_t)0)
#define EMC_DBG_WRITE_MUX_ACTIVE         ((uint32_t)1)
#define EMC_FBIO_CFG5_DRAM_TYPE_DDR4     ((uint32_t)0)
#define EMC_FBIO_CFG5_DRAM_TYPE_LPDDR4  ((uint32_t)1)
#define EMC_FBIO_CFG5_DRAM_TYPE_LPDDR2  ((uint32_t)2)
#define EMC_FBIO_CFG5_DRAM_TYPE_DDR2     ((uint32_t)3)
